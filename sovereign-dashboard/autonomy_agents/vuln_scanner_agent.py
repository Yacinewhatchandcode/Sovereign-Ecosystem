...
class VulnScannerAgent:
    ...
    async def run_cycle(self) -> VulnScannerAgentResult:
        try:
            ...
            return VulnScannerAgentResult(success=True, data=data)
        except Exception as e:
            return VulnScannerAgentResult(success=False, data=str(e))

def get_vuln_scanner_agent_agent():
