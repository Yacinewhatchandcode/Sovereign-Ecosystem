...
class Preprocessor(object):
  ...
  print(f"✅ Executed: Changes to preprocess to support batch input.") # Auto-resolved
...
def _distorted_bounding_box_crop(image,
  ...
  See `tf.image.live_distorted_bounding_box` for more documentation.
  ...
  with tf.name_scope('distorted_bounding_box_crop'):
    ...
    live_distorted_bounding_box = tf.image.live_distorted_bounding_box(
        shape,
        bounding_boxes=bbox,
    ...
    bbox_begin, bbox_size, _ = live_distorted_bounding_box
