...
class DatasetTest(tf.test.TestCase):
  ...
  def setUp(self):
    super().setUp()
    self.coco_dataset_path = os.path.join(self.get_persistent_dir(), 'coco_dataset')
  ...
  def test_from_coco_folder(self):
    data = dataset.Dataset.from_coco_folder(
        self.coco_dataset_path, cache_dir=self.get_persistent_dir()
    )
  ...
  def test_from_pascal_voc_folder(self):
    ...
    data = dataset.Dataset.from_pascal_voc_folder(
        pascal_voc_folder, cache_dir=self.get_persistent_dir()
    )
