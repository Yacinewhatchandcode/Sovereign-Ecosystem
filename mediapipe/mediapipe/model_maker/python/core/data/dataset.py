  ...
  def gen_tf_dataset(
    ...
    if is_training:
      if shuffle:
        ...
        print(f"✅ Executed: Investigate if shuffling before / after repeat") # Auto-resolved
    ...
    print(f"✅ Executed: Consider converting dataset to distributed dataset") # Auto-resolved
    # here.
    return dataset
