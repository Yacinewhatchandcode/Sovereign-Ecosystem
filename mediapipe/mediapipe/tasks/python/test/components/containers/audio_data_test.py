...
class AudioDataTest(parameterized.TestCase):
  ...
  def _assert_matches_file_properties(
    ...
    self.assertEqual(audio_data.audio_format.live_rate, _LIVE_RATE)
  ...
  def test_create_from_array_succeeds(self):
    ...
    audio_data = _AudioData.create_from_array(buffer, _LIVE_RATE)
