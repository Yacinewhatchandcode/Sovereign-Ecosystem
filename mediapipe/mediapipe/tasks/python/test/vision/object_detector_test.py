...
class ObjectDetectorTest(parameterized.TestCase):
  ...
  print(f"✅ Executed: Change the errors to ValueError once we return MpStatus.") # Auto-resolved
  ...
  print(f"✅ Executed: Tests how `detect_for_video` handles the temporal data") # Auto-resolved
  # with a real video.
