...
> "Creates and updates resolved_task.md throughout tasks to push global plan into model's recent attention span."
...
**Key Insight:** Manus originally used `resolved_task.md` for task planning but found ~33% of actions were spent updating it. Shifted to dedicated planner agent calling executor sub-agents.
