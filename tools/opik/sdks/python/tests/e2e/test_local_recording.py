...
def test_cleanup_and_reuse_after_exit__should_save_new_data():
    ...
    with opik.record_traces_locally() as storage:
        _ = _live_tracked_function("first run")
    ...
    with opik.record_traces_locally() as storage:
        _ = _live_tracked_function("second run")
