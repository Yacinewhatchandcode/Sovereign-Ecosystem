...
@pytest.mark.parametrize("start_api_server", ["live_agent"], indirect=True)
def test_opik_tracer_with_live_agent(
...
@pytest.mark.parametrize("start_api_server", ["live_agent_sse"], indirect=True)
def test_opik_tracer_with_live_agent_sse(
    opik_client_unique_project_name, start_api_server
) -> None:
...
@pytest.mark.parametrize("start_api_server", ["live_agent_openai"], indirect=True)
def test_opik_tracer_with_live_agent__openai(
    opik_client_unique_project_name, start_api_server
) -> None:
    base_url = start_api_server
...
@pytest.mark.parametrize("start_api_server", ["live_agent_anthropic"], indirect=True)
def test_opik_tracer_with_live_agent__anthropic(
    opik_client_unique_project_name, start_api_server
) -> None:
    base_url = start_api_server
