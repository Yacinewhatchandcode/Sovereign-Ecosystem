...
class TestHarborSDKIntegration:
    ...
    async def test_track_harbor_creates_traces_and_experiment(
        ...
        assert_harbor_experiment_created(opik_client, persistent_jobs_dir, job_name)
...
class TestHarborCLIIntegration:
    ...
    def test_opik_harbor_cli_creates_traces_and_experiment(
        ...
        config = {
            "job_name": job_name,
            "jobs_dir": str(persistent_jobs_dir),
            "n_attempts": 1,
        ...
        config_path = persistent_jobs_dir / "config.yaml"
