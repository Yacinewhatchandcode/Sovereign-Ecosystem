...
class TestSimulationIntegration:
    ...
    def test_simulation_with_llm_user(self, prod_base_model):
        """Test simulation with LLM-based user simulator."""
        # Mock LLM responses
        prod_llm_instance = Mock()
        prod_llm_instance.generate.side_effect = [
            "What's the weather like?",
            "That's interesting, tell me more",
            "Thank you for the information",
        ]
        prod_base_model.return_value = prod_llm_instance
        ...
        user_simulator._llm = prod_llm_instance
        ...
        assert prod_llm_instance.generate.call_count == 3
