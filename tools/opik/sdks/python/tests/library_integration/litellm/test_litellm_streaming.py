...
def test_litellm_completion_streaming__happyflow(
    real_backend, model, expected_provider
):
...
@pytest.mark.asyncio
async def test_litellm_acompletion_streaming__happyflow(real_backend):
...
def test_litellm_completion_streaming_with_opik_args__happyflow(real_backend):
