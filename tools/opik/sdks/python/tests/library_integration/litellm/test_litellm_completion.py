...
def test_litellm_completion_create__happyflow(real_backend, model, expected_provider):
...
@pytest.mark.asyncio
async def test_litellm_acompletion_create__happyflow(real_backend):
...
def test_litellm_completion_error_handling__exception_logged(real_backend):
...
def test_litellm_completion_with_tools__tools_logged(real_backend):
...
def test_litellm_completion_create__opik_args__happyflow(real_backend):
...
@pytest.mark.asyncio
async def test_litellm_acompletion_create__opik_args__happyflow(real_backend):
...
def test_litellm_completion_double_decoration__idempotent(real_backend):
