...
def test_litellm_chat_model_generate_string__happyflow(real_backend, monkeypatch):
...
def test_litellm_chat_model_with_track_true__traces_created(real_backend, monkeypatch):
