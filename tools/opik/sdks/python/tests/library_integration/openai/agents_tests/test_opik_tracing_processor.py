...
def test_opik_tracing_processor__happy_flow(real_backend):
...
def test_opik_tracing_processor__happy_flow_conversation(real_backend):
    input_message = "Write a haiku about recursion in programming."
    project_name = "opik-test-openai-agents"
...
@pytest.mark.asyncio
async def test_opik_tracing_processor__handsoff(real_backend):
...
@pytest.mark.asyncio
async def test_opik_tracing_processor__functions(real_backend):
    @function_tool
