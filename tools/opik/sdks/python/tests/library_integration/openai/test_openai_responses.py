...
def test_openai_client_responses_create_stream__happyflow(real_backend):
    client = openai.OpenAI()
    wrapped_client = track_openai(openai_client=client)
    messages = [
        {"role": "system", "content": "You are a helpful assistant."},
...
@pytest.mark.asyncio
async def test_openai_client_responses_create_async__happyflow(real_backend):
...
@pytest.mark.asyncio
async def test_openai_client_responses_create_stream_async__happyflow(real_backend):
    client = openai.AsyncOpenAI()
    wrapped_client = track_openai(openai_client=client)
    messages = [
        {"role": "system", "content": "You are a helpful assistant."},
...
@pytest.mark.asyncio
async def test_openai_client_responses_parse_async__happy_flow(real_backend):
    client = openai.AsyncOpenAI()
    wrapped_client = track_openai(
        openai_client=client,
    )
