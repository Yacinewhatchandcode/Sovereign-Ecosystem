...
def test_track_langgraph__multiple_invocations__all_tracked(
    ...
    assert_equal(EXPECTED_TRACE_1, real_backend.trace_trees[0])
    ...
    assert_equal(EXPECTED_TRACE_2, real_backend.trace_trees[1])
    ...
    assert_equal(EXPECTED_TRACE_3, real_backend.trace_trees[2])
