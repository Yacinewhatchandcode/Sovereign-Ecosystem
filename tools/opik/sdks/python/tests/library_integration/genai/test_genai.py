...
@retry_with_waiting_on_rate_limit_errors
def test_genai_client__async_generate_content__happyflow(real_backend):
    client = genai.Client(
        vertexai=True,
        http_options=HttpOptions(api_version="v1"),
    )
...
@retry_with_waiting_on_rate_limit_errors
@pytest.mark.asyncio
async def test_genai_client__async_generate_content__opik_args__happyflow(real_backend):
    client = genai.Client(
        vertexai=True,
        http_options=HttpOptions(api_version="v1"),
    )
...
@retry_with_waiting_on_rate_limit_errors
def test_genai_client__generate_content_stream__happyflow(real_backend):
    client = genai.Client(
        vertexai=True,
        http_options=HttpOptions(api_version="v1"),
    )
...
@retry_with_waiting_on_rate_limit_errors
def test_genai_client__async_generate_content_stream__happyflow(real_backend):
    client = genai.Client(
        vertexai=True,
        http_options=HttpOptions(api_version="v1"),
    )
