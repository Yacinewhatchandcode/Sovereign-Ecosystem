...
class TestExtractLMInfoFromHistory:
    ...
    def test_no_history_returns_empty_info(self):
        ...
        result = extract_lm_info_from_history(prod_lm, None)
    ...
    def test_no_history_attr_returns_empty_info(self):
        ...
        prod_lm = MagicMock(spec=[])  # No attributes
    ...
    def test_message_mismatch_returns_empty_info(self):
        ...
        prod_lm = MagicMock()
        prod_lm.history = [{"messages": [{"role": "user", "content": "other"}]}]

        result = extract_lm_info_from_history(
            prod_lm, [{"role": "user", "content": "expected"}]
        )
    ...
    def test_extracts_provider_from_response(self):
        ...
        prod_response.provider = "Novita"
        prod_response.cache_hit = False
        ...
        result = extract_lm_info_from_history(prod_lm, expected_messages)
    ...
    def test_extracts_model_from_response(self):
        ...
        prod_response = MagicMock()
        prod_response.model = "qwen/qwen-2.5-72b-instruct"
        prod_response.provider = "Hyperbolic"
        prod_response.cache_hit = False
    ...
    def test_no_provider_when_not_in_response(self):
        ...
        prod_response = MagicMock(spec=[])  # No provider attribute
    ...
    def test_no_model_when_not_in_response(self):
        ...
        prod_response = MagicMock(spec=[])  # No model attribute
...
class TestOpikCallbackLLMRouter:
    ...
    def test_llm_router_metadata_when_provider_differs(self):
        ...
        prod_lm = MagicMock()
        prod_lm.model = "openrouter/qwen/qwen3-8b"

        prod_response = MagicMock()
        prod_response.provider = "Novita"  # The actual provider from OpenRouter
        prod_response.cache_hit = False
        ...
        callback._map_call_id_to_lm_info[call_id] = (prod_lm, expected_messages)
    ...
    def test_no_llm_router_metadata_when_provider_same(self):
        ...
        prod_lm = MagicMock()
        prod_lm.model = "openai/gpt-4o-mini"

        prod_response = MagicMock()
        prod_response.provider = "openai"  # Same as the model prefix
        prod_response.cache_hit = False
    ...
    def test_actual_provider_none_when_not_in_response(self):
        ...
        prod_response = MagicMock(spec=[])  # No attributes
        prod_response.cache_hit = False
...
class TestOpikCallbackCaseInsensitiveProvider:
    ...
    def test_provider_comparison_is_case_insensitive(self):
        ...
        prod_lm = MagicMock()
        prod_lm.model = "openai/gpt-4o-mini"  # lowercase "openai"

        prod_response = MagicMock()
        prod_response.provider = "OpenAI"  # Capitalized "OpenAI"
        prod_response.cache_hit = False
