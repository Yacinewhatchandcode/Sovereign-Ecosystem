...
def test_bedrock_invoke_model__anthropic___streaming__happyflow(real_backend):
    ...
    assert len(real_backend.trace_trees) == 1
    assert_equal(expected_trace, real_backend.trace_trees[0])


def test_bedrock_invoke_model__amazon_nova___non_streaming__happyflow(real_backend):
...
def test_bedrock_invoke_model__amazon_nova___streaming__happyflow(real_backend):
...
def test_bedrock_invoke_model__meta_llama___non_streaming__happyflow(real_backend):
...
def test_bedrock_invoke_model__meta_llama___streaming__happyflow(real_backend):
...
def test_bedrock_invoke_model__mistral___non_streaming__happyflow(real_backend):
...
def test_bedrock_invoke_model__mistral___streaming__happyflow(real_backend):
