...
def test_bedrock_converse__happyflow(real_backend, project_name, expected_project_name):
...
def test_bedrock_converse__stream_called_2_times__generator_tracked_correctly(
    ...
    assert_equal(expected_trace1, real_backend.trace_trees[0])
    assert_equal(expected_trace2, real_backend.trace_trees[1])
