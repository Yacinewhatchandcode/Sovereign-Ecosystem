...
@pytest.fixture
def real_warning_event():
    return {"level": "warning"}


@pytest.fixture
def real_error_event():
    return {"level": "error"}


@pytest.fixture
def real_error_event_with_status_code_401():
    return {"level": "error", "extra": {"error_tracking_extra": {"status_code": 401}}}


@pytest.fixture
def real_error_event_with_status_code_500():
...
@pytest.fixture
def real_hint_with_exception_with_status_code_401():
    return _generate_hint(FakeExceptionWithStatus(401))


@pytest.fixture
def real_hint_with_exception_with_status_code_500():
