...
def test_prompt__format__one_system_value_used_multiple_times():
    PROMPT_TEMPLATE = (
...
def test_prompt__format__passed_arguments_that_are_not_in_template__error_raised_with_correct_report_info():
    ...
    assert exc_info.value.prompt_system_values == set(
        [
            "name",
            "city",
        ]
...
def test_prompt__format__some_system_values_dont_have_corresponding_format_arguments__error_raised_with_correct_report_info():
    PROMPT_TEMPLATE = "Hi, my name is {{name}}, I live in {{city}}."
...
def test_prompt__format__some_system_values_dont_have_corresponding_format_arguments_AND_there_are_format_arguments_that_are_not_in_the_template__error_raised_with_correct_report_info():
    PROMPT_TEMPLATE = "Hi, my name is {{name}}, I live in {{city}}."
