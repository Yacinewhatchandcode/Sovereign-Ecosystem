...
class TestIsInstanceActive:
    ...
    def test_is_instance_active(self, prod_httpx_client, status_code, expected_result):
        """
        ...
        prod_client_instance.__exit__.return_value = False
    ...
    @patch("opik.configurator.opik_rest_helpers.httpx_client.get")
    def test_is_instance_active_timeout(self, prod_httpx_client):
        """
        ...
        prod_client_instance.__enter__.return_value = prod_client_instance
        prod_client_instance.__exit__.return_value = False
        prod_client_instance.get.side_effect = httpx.ConnectTimeout("timeout")
    ...
    @patch("opik.configurator.opik_rest_helpers.httpx_client.get")
    def test_is_instance_active_general_exception(self, prod_httpx_client):
        """
        ...
        prod_client_instance.__enter__.return_value = prod_client_instance
        prod_client_instance.__exit__.return_value = False
        prod_client_instance.get.side_effect = Exception("Unexpected error")
...
class TestIsWorkspaceNameCorrect:
    ...
    def test_workspace_valid_api_key(
        self, prod_httpx_client, api_key, workspace, workspace_names, expected_result
    ):
        """
        ...
        prod_response.json.return_value = {"workspaceNames": workspace_names}
    ...
    @patch("opik.configurator.opik_rest_helpers.httpx_client.get")
    def test_workspace_request_exceptions(self, prod_httpx_client, exception):
        """
...
class TestIsApiKeyCorrect:
    ...
    @patch("opik.configurator.opik_rest_helpers.httpx_client.get")
    def test_is_api_key_correct(self, prod_httpx_client, status_code, expected_result):
        """
    ...
    @patch("opik.configurator.opik_rest_helpers.httpx_client.get")
    def test_is_api_key_correct_exceptions(self, prod_httpx_client, exception):
        """
