...
class TestAskUserForApproval:
    ...
    def test_user_approves_with_y(self, prod_input):
        """
    ...
    def test_user_approves_with_yes(self, prod_input):
        """
    ...
    def test_user_approves_with_empty_input(self, prod_input):
        """
    ...
    def test_user_disapproves_with_n(self, prod_input):
        """
    ...
    def test_user_disapproves_with_no(self, prod_input):
        """
    ...
    def test_user_enters_invalid_choice_then_approves(
        self, prod_logger_error, prod_input
    ):
        """
        ...
        result = ask_user_for_approval("Do you approve?")
        assert result is True
        prod_logger_error.assert_called_once_with("Wrong choice. Please try again.")
