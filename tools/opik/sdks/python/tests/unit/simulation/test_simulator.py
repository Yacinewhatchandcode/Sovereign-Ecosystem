...
class TestRunSimulation:
    ...
    def test_run_simulation_basic(self):
        ...
        def prod_app(message, *, thread_id, **kwargs):
        ...
        result = run_simulation(
            app=prod_app, user_simulator=user_simulator, max_turns=3
        )
    ...
    def test_run_simulation_with_app_kwargs(self):
        ...
        def prod_app(message, *, thread_id, custom_param=None, **kwargs):
    ...
    def test_run_simulation_generates_thread_id(self, prod_generate_id):
        """Test that thread_id is generated when not provided."""
        prod_generate_id.return_value = "generated-thread-456"
        ...
        result = run_simulation(
            app=prod_app, user_simulator=user_simulator, max_turns=1
        )

        assert result["thread_id"] == "generated-thread-456"
        prod_generate_id.assert_called_once()
    ...
    def test_run_simulation_max_turns_zero(self):
        ...
        result = run_simulation(
            app=prod_app, user_simulator=user_simulator, max_turns=0
        )
