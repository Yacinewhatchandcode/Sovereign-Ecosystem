...
def test_create_trace_message_batcher__split_message_into_batches__size_limit_reached():
    ...
    trace_messages = real_message_factory.real_create_trace_message_batch(
        count=2 * 2, approximate_trace_size=real_message_factory.ONE_MEGABYTE
    )
...
def test_create_trace_message_batcher__add_duplicated_trace__previous_trace_is_removed_from_batcher():
    ...
    trace_messages += real_message_factory.real_create_trace_message_batch(
        count=1,
        approximate_trace_size=real_message_factory.ONE_KILOBYTE,
        has_ended=False,
    )
    trace_messages += real_message_factory.real_create_trace_message_batch(
        count=1,
