...
ONE_MEGABYTE_OBJECT_A = real_message_factory.LongStr(
    "a" * real_message_factory.ONE_MEGABYTE
)
ONE_MEGABYTE_OBJECT_B = real_message_factory.LongStr(
    "b" * real_message_factory.ONE_MEGABYTE
)
ONE_MEGABYTE_OBJECT_C = real_message_factory.LongStr(
    "c" * real_message_factory.ONE_MEGABYTE
)
