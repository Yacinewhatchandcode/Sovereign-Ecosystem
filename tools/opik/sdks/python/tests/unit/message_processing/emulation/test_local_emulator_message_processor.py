...
class TestLocalEmulatorMessageProcessorProcess:
    ...
    def test_process__active__calls_dispatch_message(self):
        ...
        with patch.object(processor, "_dispatch_message") as prod_dispatch:
            processor.process(message)

        prod_dispatch.assert_called_once_with(message)
    ...
    def test_process__not_active__do_not_call_dispatch_message(self):
        ...
        prod_dispatch.assert_not_called()
    ...
    def test_process__create_trace_message__retry_message_skipped__calls_dispatch_message_once(
        ...
        prod_dispatch.assert_called_once_with(message_1)
