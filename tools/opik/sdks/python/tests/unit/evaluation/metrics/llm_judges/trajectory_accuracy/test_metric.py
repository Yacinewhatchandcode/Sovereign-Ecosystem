...
class TestTrajectoryAccuracy:
    ...
    @pytest.fixture
    def trajectory_metric(self, prod_model):
        ...
        metric = TrajectoryAccuracy(model=prod_model, track=False)
        return metric

    def test_score_basic_trajectory(self, trajectory_metric, prod_model):
    ...
    def test_score_model_error_handling(self, trajectory_metric, prod_model):
    ...
    def test_init_model_string_model_name(self, prod_factory):
        ...
        prod_model.generate_string.return_value = (
