...
class TestSeedParameter:
    ...
    def test_answer_relevance_seed_parameter_passing(self, test_seed: int) -> None:
        ...
        with patch(
            ...
            prod_model = Mock(spec=base_model.OpikBaseModel)
            ...
            with patch(
                ...
                prod_parser.return_value = score_result.ScoreResult(
                ...
                prod_factory.assert_called_once()
                factory_call_kwargs = prod_factory.call_args[1]
    ...
    def test_g_eval_seed_parameter_passing(self, test_seed: int) -> None:
        ...
        with patch(
            ...
            with patch(
                ...
                assert prod_model.generate_string.call_count >= 1
