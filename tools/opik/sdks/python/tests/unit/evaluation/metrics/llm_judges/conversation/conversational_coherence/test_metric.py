...
def test_score__with_all_relevant_responses(prod_model, simple_conversation):
    """Test scoring with all LLM responses being relevant."""

    # Mock model response to return yes as verdicts
    prod_model.generate_string.side_effect = _all_relevant_responses_side_effect
...
async def test_score__with_all_relevant_responses__async(
    ...
    """Test scoring with all LLM responses being relevant."""
    # Mock model response to return yes as verdicts
    prod_model.agenerate_string.side_effect = _all_relevant_responses_side_effect
...
def test_score__with_mixed_relevance(prod_model, irrelevant_conversation):
    """Test scoring with a mix of relevant and irrelevant responses."""

    # Mock model response to alternate between yes and no
    prod_model.generate_string.side_effect = _mixed_relevance_side_effect
...
@pytest.mark.asyncio
async def test_score__with_mixed_relevance__async(prod_model, irrelevant_conversation):
    """Test scoring with a mix of relevant and irrelevant responses."""
    # Mock model response to alternate between yes and no
    prod_model.agenerate_string.side_effect = _mixed_relevance_side_effect
...
def test_score_with_no_reason(prod_model):
    ...
    metric = ConversationalCoherenceMetric(
        model=prod_model, include_reason=False, track=False
    )
