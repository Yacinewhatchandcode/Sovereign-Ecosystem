...
@pytest.mark.parametrize(
    "real_backend_with_patched_environment",
...
def test_track__trace_logged_at_start_and_end__flush_before_end__both_traces_sent(
    ...
    real_backend_with_patched_environment.merge_duplicates = False
    ...
    trace_trees = real_backend_with_patched_environment.trace_trees
