...
def test_start_as_current_trace__inside__happy_flow(real_backend):
...
def test_start_as_current_trace__outside__happy_flow(real_backend):
...
def test_start_as_current_trace__mixed__inside_override_outside(real_backend):
...
def test_start_as_current_trace__user_error__logged_and_raised(real_backend):
...
def test_start_as_current_trace__minimal_parameters__works(real_backend):
...
def test_start_as_current_trace__context_cleanup__trace_removed_after_exit(
    ...
    assert len(real_backend.trace_trees) == 1
    assert real_backend.trace_trees[0].name == "test-trace"
