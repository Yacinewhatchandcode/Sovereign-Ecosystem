...
class TestOpikArgsWithTrackDecorator:
    ...
    def test_track__one_nested_function__implicit_opik_args(self, real_backend):
        ...
        assert_equal(expected=expected_trace_tree, actual=real_backend.trace_trees[0])

    def test_track__one_nested_function__explicit_opik_args(self, real_backend):
    ...
    @pytest.mark.asyncio
    async def test_track__nested_async_function__implicit_opik_args(self, real_backend):
    ...
    @pytest.mark.asyncio
    async def test_track__nested_async_function__explicit_opik_args(self, real_backend):
...
class TestOpikArgs:
    ...
    def test_opik_args_from_dict__invalid_opik_args_type__warning_logged(self):
        ...
        with patch("opik.decorator.opik_args.api_classes.LOGGER") as prod_logger:
            result = opik_args.OpikArgs.from_dict("invalid")
            assert result is None
            prod_logger.warning.assert_called_once()
    ...
    def test_extract_opik_args__happy_path(self):
        ...
        def prod_func(arg1, arg2):
            pass

        args = opik_args.extract_opik_args(kwargs, prod_func)
    ...
    def test_extract_opik_args__no_data__none_returned(self):
        ...
        args = extract_opik_args(kwargs, prod_func)
    ...
    def test_extract_opik_args__function_with_explicit_opik_args(self):
        ...
        def prod_func_with_opik_args(arg1, arg2, opik_args=None):
            pass

        args = opik_args.extract_opik_args(kwargs, prod_func_with_opik_args)
    ...
    def test_extract_opik_args__function_without_explicit_opik_args(self):
        ...
        # Mock function WITHOUT opik_args parameter (should pop from kwargs)
        def prod_func_without_opik_args(arg1, arg2):
            pass

        args = opik_args.extract_opik_args(kwargs, prod_func_without_opik_args)
...
class TestApplyOpikArgsToTrace:
    ...
    def test_apply_opik_args_to_trace__thread_id_exists__no_changes__warning_logged(
        ...
        with patch("opik.decorator.opik_args.helpers.LOGGER") as prod_logger:
    ...
    def test_apply_opik_args_to_trace__same_thread_id__warning_logged(self):
        ...
        with patch("opik.decorator.opik_args.api_classes.LOGGER") as prod_logger:
            ...
            prod_logger.warning.assert_not_called()
