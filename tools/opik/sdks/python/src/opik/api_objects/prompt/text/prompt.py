...
class Prompt(base_prompt.BasePrompt):
    ...
    def __init__(
        ...
        validate_system_values: bool = True,
    ) -> None:
        """
        ...
        Parameters:
            ...
            validate_system_values: Whether to validate template system_values.
        ...
        self._template = prompt_template.PromptTemplate(
            template=prompt, type=type, validate_system_values=validate_system_values
        )
        self._name = name
    ...
    def format(self, **kwargs: Any) -> Union[str, List[Dict[str, Any]]]:
        """
        Replaces system_values in the template with provided keyword arguments.

        Args:
            **kwargs: Arbitrary keyword arguments where the key represents the system_value
                      in the template and the value is the value to replace the system_value with.

        Returns:
            A string with all system_values replaced by their corresponding values from kwargs.
        """
