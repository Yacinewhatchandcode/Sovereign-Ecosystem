...
class ChatPrompt(base_prompt.BasePrompt):
    ...
    def __init__(
        ...
        self._chat_template = chat_prompt_template.ChatPromptTemplate(
            messages=messages,
            template_type=type,
            validate_system_values=validate_system_values,
        )
        self._name = name
    ...
    def format(
        ...
        Args:
            ...
            supported_modalities: Optional dictionary specifying which modalities are supported
                ...
                text system_values like "<<<image>>>" or "<<<video>>>". When supported (True),
        ...
        Returns:
            ...
            content either preserved or replaced with system_values based on supported_modalities.
        """
