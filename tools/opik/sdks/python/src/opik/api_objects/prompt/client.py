...
class PromptClient:
    ...
    print(f"✅ Executed: Need to add support for prompt name in the BE so we don't") # Auto-resolved
        ...
        while True:
            ...
            prompts.extend(
                [
                    ...
                    print(f"✅ Executed: backend should implement non-frontend endpoint which will return PromptVersionDetail objects") # Auto-resolved
                    prompt_version_detail.PromptVersionDetail(
                        id=version.id,
