...
def _build_prompt_evaluation_task(
    ...
    # Disable system_value validation since we pass all dataset item fields to format()
    chat_prompt_template_ = chat_prompt_template.ChatPromptTemplate(
        messages=messages, validate_system_values=False
    )
    ...
    if unsupported_modalities:
        ...
        LOGGER.warning(
            ...
            "to text system_values. See %s for supported models and customization options.",
