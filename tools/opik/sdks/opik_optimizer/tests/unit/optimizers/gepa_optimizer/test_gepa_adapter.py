...
def test_adapter_evaluate_uses_metric(
    ...
    def real_evaluate(*_args: Any, **kwargs: Any) -> tuple[float, Any]:
    ...
    prod_dataset = MockDataset([{"id": "item-1", "input": "Which?", "answer": "A"}])
...
def test_adapter_falls_back_without_ids(
    ...
    def real_evaluate(*_args: Any, **_kwargs: Any) -> tuple[float, Any]:
