...
class TestMultiMetricObjective:
    ...
    def test_metric_with_task_span_signature__needs_task_span_is_true(self) -> None:
        ...
        prod_span = Mock(spec=SpanModel)
        result = multi_metric(dataset_item={}, llm_output="test", task_span=prod_span)
    ...
    def test_mixed_metrics_with_and_without_task_span(self) -> None:
        ...
        assert received_spans[0] is prod_span, "Task span should be passed through"
