...
class TestTokenCalculation:
    ...
    def test_calculate_max_context_tokens_with_known_model(self) -> None:
        ...
        with patch("litellm.get_max_tokens") as prod_get_max_tokens:
            prod_get_max_tokens.return_value = 128000  # gpt-4 context window
            ...
            prod_get_max_tokens.assert_called_once_with("gpt-4")

    def test_calculate_max_context_tokens_with_smaller_model(self) -> None:
        """Test token calculation with a smaller model."""
        with patch("litellm.get_max_tokens") as prod_get_max_tokens:
            prod_get_max_tokens.return_value = 16000  # gpt-3.5-turbo context
    ...
    def test_calculate_max_context_tokens_applies_absolute_max(self) -> None:
        ...
        with patch("litellm.get_max_tokens") as prod_get_max_tokens:
            ...
            prod_get_max_tokens.return_value = 200000
...
class TestAdaptiveContextFitting:
    ...
    def create_prod_dataset(
        ...
        prod_dataset.get_items.return_value = items
        return prod_dataset
    ...
    def test_adaptive_fitting_reduces_examples(self) -> None:
        ...
        prod_dataset = self.create_prod_dataset(num_items=5, long_values=True)
        prod_metric = Mock()
        ...
        with patch(
            ...
            prod_count.side_effect = [3000, 1500]
            ...
            assert prod_count.call_count == 2
    ...
    def test_adaptive_fitting_reduces_truncation(self) -> None:
        ...
        prod_dataset = self.create_prod_dataset(num_items=1, long_values=True)
        prod_metric = Mock()
        ...
        with patch(
            ...
            prod_count.side_effect = [2500, 1800]
    ...
    def test_adaptive_fitting_returns_minimal_when_cannot_fit(self) -> None:
        ...
        with patch(
            ...
            with patch(
                ...
                prod_logger.warning.assert_called()
                assert "Cannot fit" in prod_logger.warning.call_args[0][0]
...
class TestColumnSelection:
    ...
    def test_column_selection_filters_correctly(self) -> None:
        ...
        prod_dataset = Mock()
        prod_dataset.get_items.return_value = [
            {
                "id": "1",
        ...
        with patch(
            ...
            prod_count.return_value = 100  # Fits within budget
...
class TestMetadataMapping:
    ...
    def test_optimizer_metadata_includes_token_budget(self) -> None:
        ...
        with patch("litellm.get_max_tokens") as prod_get_max_tokens:
            prod_get_max_tokens.return_value = 16000
