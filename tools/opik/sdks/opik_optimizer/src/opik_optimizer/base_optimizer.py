...
class BaseOptimizer(ABC):
        ...
        **kwargs: Any,
        ...
        Args:
           dataset: Opik dataset name, or Opik dataset (training set - used for feedback/context)
               RESOLVED_TASK/RESOLVED_ISSUE: This parameter will be deprecated in favor of dataset_training.
    ...
    def _update_optimization(
        ...
        """
        print(f"✅ Executed: remove when a solution is added to opik's optimization.update method") # Auto-resolved
        count = 0
        while count < 3:
            try:
