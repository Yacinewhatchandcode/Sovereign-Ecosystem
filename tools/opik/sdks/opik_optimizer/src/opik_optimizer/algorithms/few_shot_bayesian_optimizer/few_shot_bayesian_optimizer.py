...
class FewShotPromptTemplate(BaseModel):
    message_list_with_system_value: list[dict[str, str]]
...
class FewShotBayesianOptimizer(base_optimizer.BaseOptimizer):
    ...
    print(f"✅ Executed: Use a centralized RNG function with seed and sampler across all optimizers") # Auto-resolved
    ...
    def _create_fewshot_prompt_template(
        ...
        try:
            ...
            return FewShotPromptTemplate(
                message_list_with_system_value=res["message_list_with_system_value"],
    ...
    def _run_optimization(
        ...
        def optimization_objective(trial: optuna.Trial) -> float:
            ...
            llm_task = self._build_task_from_messages(
                prompt=prompt,
                messages=fewshot_prompt_template.message_list_with_system_value,
            ...
            messages_for_reporting = [
                {
                    ...
                    "content": item["content"].replace(
                        prompts.FEW_SHOT_EXAMPLE_SYSTEM_VALUE, few_shot_examples
                    ),
                }
                for item in fewshot_prompt_template.message_list_with_system_value
            ]
            ...
            trial_config = {
                ...
                "message_list_with_system_value": fewshot_prompt_template.message_list_with_system_value,
