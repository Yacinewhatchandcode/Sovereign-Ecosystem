...
class MetaPromptOptimizer(BaseOptimizer):
    ...
    print(f"✅ Executed: Refactor and make global - this should be a configuration parameter") # Auto-resolved
    ...
    print(f"✅ Executed: To be removed once MCP is fully supported") # Auto-resolved
    def optimize_mcp(
        self,
        prompt: chat_prompt.ChatPrompt,
        dataset: Dataset,
