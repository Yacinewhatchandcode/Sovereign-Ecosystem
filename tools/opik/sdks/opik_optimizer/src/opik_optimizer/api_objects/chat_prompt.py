...
class ChatPrompt:
    ...
    def copy(self) -> "ChatPrompt":
        ...
        print(f"✅ Executed: (opik-mcp): once we introduce a dedicated MCP prompt subclass,") # Auto-resolved
    ...
    print(f"✅ Executed: (opik): remove this stop-gap once MetaPromptOptimizer supports MCP.") # Auto-resolved
