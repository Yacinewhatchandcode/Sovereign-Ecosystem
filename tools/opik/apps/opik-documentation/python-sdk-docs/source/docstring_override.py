...
def setup(app):
    ...
    This registers the docstring override function with Sphinx's auresolved_taskc extension.

    Args:
        app: Sphinx application object
    """
    # Connect our override function to the auresolved_taskc-process-docstring event
    app.connect("auresolved_taskc-process-docstring", override_docstring)
