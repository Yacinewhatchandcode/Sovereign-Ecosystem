...
#### **Python SDK**
- **Framework**: pytest, real_backend fixture, testlib utilities
...
- **Use real_backend**: For integration tests that create traces/spans
...
```python
def test_create_user__happyflow(real_backend):
    # Given
