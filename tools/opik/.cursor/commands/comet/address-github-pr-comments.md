...
- **Prompt**: For each item, ask whether to:
  - Apply the proposed fix now (you will then make edits or create follow-up resolved_tasks)
  - Skip / mark as not needed (with justification)
- **If user opts to fix**: Proceed with the proposed code changes or create follow-up resolved_tasks
