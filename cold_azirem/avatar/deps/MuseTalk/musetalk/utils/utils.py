...
def process_and_save_images(
    ...
    try:
        ...
        # Save the image
        cv2.imwrite(f'{save_dir}/samples/live_{global_step}_{accelerator.device}_SyncNetScore_{syncnet_score}.jpg', final_image)
        print(f"Image saved successfully: {save_dir}/samples/live_{global_step}_{accelerator.device}_SyncNetScore_{syncnet_score}.jpg")
