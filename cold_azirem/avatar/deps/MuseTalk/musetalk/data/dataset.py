...
from musetalk.data.live_method import get_src_idx, shift_landmarks_to_face_coordinates, resize_landmark 
...
class FaceDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.T = cfg['T']
        self.live_method = cfg['live_method']
        ...
        print("The sample method is: ", self.live_method)
    ...
    def get_syncnet_input(self, video_path):
        ...
        """
        ar = AudioReader(video_path, live_rate=16000)
    ...
    def __getitem__(self, idx):
        ...
        while attempts < self.max_attempts:
            ...
            for drive_idx in drive_idx_list:
                src_idx = get_src_idx(
                    drive_idx, T, self.live_method, shift_landmarks, face_shapes, self.top_k_ratio)
                if src_idx is None:
...
if __name__ == '__main__':
    ...
    dataset = PortraitDataset(cfg={
        ...
        'live_method': 'pose_similarity_and_mouth_dissimilarity',  # Method for selecting reference frames
