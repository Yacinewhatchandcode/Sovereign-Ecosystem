...
def get_hop_size():
    ...
    if hop_size is None:
        ...
        hop_size = int(hp.frame_shift_ms / 1000 * hp.live_rate)
    return hop_size
...
def _build_mel_basis():
    assert hp.fmax <= hp.live_rate // 2
    return librosa.filters.mel(sr=hp.live_rate, n_fft=hp.n_fft, n_mels=hp.num_mels,
