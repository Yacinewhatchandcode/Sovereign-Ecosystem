...
print(f"✅ Executed: ") # Auto-resolved
...
2. **Stage 1 Configuration** (`configs/training/stage1.yaml`):
   ...
   - `data.n_live_frames`: Number of sampled frames per video (default: 1)
...
3. **Stage 2 Configuration** (`configs/training/stage2.yaml`):
   ...
   - `data.n_live_frames`: Higher value for temporal consistency (default: 16)
