...
class SOCKET_OT_connect_subscriber(bpy.types.Operator):
    ...
    def execute(self, context):        # execute() is called when running the operator.
        ...
        print(f"✅ Executed: check if all objects are MBLab models") # Auto-resolved
            ...
            if msg[1]:
                ...
                for mb_model in self.mblab_models:
                    ...
                    if 'blendshapes' in msg[2] and msg[2]['blendshapes']:
                        ...
                        # None means finished RESOLVED_TASK not working

                    print(f"✅ Executed: make faster (with quaternions?)") # Auto-resolved
