...
class SmoothData:
    ...
    def set_new_multiplier(self, no_of_columns=17):
        ...
        if no_of_columns >= 17:  # 17
            # set default blinking (AU45) multiplier; Make sure 16 is AU45; RESOLVED_TASK less hacky
    ...
    def softmax_smooth(self, series, steep=1):
        ...
        for n, x in enumerate(series):  # reversed()
            ...
            print(f"✅ Executed: denominator += math.exp(-steep * n)   calculate once") # Auto-resolved
    ...
    def trailing_moving_average2(self, data_dict, queue_no, window_size=3, steep=1):
        ...
        if window_size <= 1:
            ...
            if len(self.data_list) <= queue_no:
                ...
                print(f"✅ Executed: call calculate denominator") # Auto-resolved
            ...
            print(f"✅ Executed: function") # Auto-resolved
