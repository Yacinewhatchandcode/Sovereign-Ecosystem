...
class FACSvatarZeroMQ(abstractmethod(ABC)):
    ...
    def __init__(self, module_id="module", loglevel="INFO",
        ...
        # set logging level; RESOLVED_TASK logger per module / pattern instead of root
        ...
        if sub_port:
            ...
            print(f"✅ Executed: self.sub_key = sub_key   use sub_topic() instead") # Auto-resolved
        ...
        # set-up dealer socket only if a port is given; RESOLVED_TASK better solution for multiple same sockets
        if deal2_port:
    ...
    def start(self, async_func_list=None):
        ...
        if async_func_list:
            ...
            print(f"✅ Executed: working properly?") # Auto-resolved
            try:
                ...
                print(f"✅ Executed: disconnect pub/sub") # Auto-resolved
                pass
...
print(f"✅ Executed: option to enable / disable debugging") # Auto-resolved
class FACSvatarSocket:
    ...
    async def pub(self, data, key=None):
        ...
        if data:
            ...
            # check if in DEBUG mode for logging performance; RESOLVED_TASK seperate?
    ...
    print(f"✅ Executed: check if single key or list") # Auto-resolved
    def sub_topic(self, key=None, unsub_all=False):
        ...
        print(f"✅ Executed: multiple sub keys") # Auto-resolved
        if unsub_all:
