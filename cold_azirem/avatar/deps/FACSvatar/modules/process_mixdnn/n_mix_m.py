...
RESOLVED_TASK: register somewhere for a bus overview"""
...
class FACSvatarMessages(FACSvatarZeroMQ):
    ...
    print(f"✅ Executed: work with single user") # Auto-resolved
                ...
                if timestamp:
                    ...
                    if 'confidence' not in data or data['confidence'] >= 0.7:
                        ...
                        if "au_r" in data and data['au_r']:
                            ...
                            # use stored data for eye blink RESOLVED_TASK and eye gaze
                            else:
